...
AC_DEFUN([AC_SF_COMPILER_SETUP],
   [AC_REQUIRE([AC_PROG_CC])
    ...
    if test "$GCC" = yes ; then
        ...
        AX_CFLAGS_GCC_OPTION(-Wwrite-strings, AM_CFLAGS)
        AX_CFLAGS_GCC_OPTION(-Wsign-compare, AM_CFLAGS)
        AX_CFLAGS_GCC_OPTION(-Wcast-align, AM_CFLAGS)
        AX_CFLAGS_GCC_OPTION(-Wextra, AM_CFLAGS)
        AX_CFLAGS_GCC_OPTION(-Wformat, AM_CFLAGS)
        AX_CFLAGS_GCC_OPTION(-Wformat-security, AM_CFLAGS)
        AX_CFLAGS_GCC_OPTION(-Wno-unused-parameter, AM_CFLAGS)
        AX_CFLAGS_GCC_OPTION(-fno-strict-aliasing, AM_CFLAGS)
        AX_CFLAGS_GCC_OPTION(-fdiagnostics-show-option, AM_CFLAGS)
        AX_CFLAGS_GCC_OPTION(-std=gnu99, AM_CFLAGS)
        AX_CFLAGS_GCC_OPTION(-pedantic, AM_CFLAGS)
    fi
])
